...
def find_afterparties():
    ...
    afterparties = res.json()
    print(afterparties['_embedded']['events'][0])
    #
    ...
    data = {'Test': afterparties,
            'page': {'totalElements': len(afterparties['_embedded']['events'])}}

    events = afterparties['_embedded']['events']
